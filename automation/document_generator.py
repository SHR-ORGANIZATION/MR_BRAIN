...
def generate_assignment(topic):
    ...
    _add_paragraph(doc, f"Generated by NOVA AI Assistant", italic=True)
...
def generate_research_proposal(topic):
    ...
    _add_paragraph(doc, "Generated by NOVA AI Assistant", italic=True)
    _add_paragraph(doc, f"Date: {datetime.now().strftime('%B %d, %Y')}")
    _add_page_break(doc)
